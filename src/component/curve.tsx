...
export default (props: Props) => {
    const d1 =
        ...
        " A" + props.curveRadius +
        "," + props.curveRadius +
        " 0 0 1 " + (Math.sin(Math.PI * props.curveAngle / 180) * (props.curveRadius - props.trackWidth / 2)) +
        ...
        " A" + props.curveRadius +
        "," + props.curveRadius +
        " 0,0,0 0," + props.trackWidth / 2 +
        " Z"

    const d2 =
        " M 0,0" +
        " A " + props.curveRadius + "," + props.curveRadius +
        " 0 0 1 " + (Math.sin(Math.PI * props.curveAngle / 180) * props.curveRadius) +
